...
namespace Demo.MySQLModelQuery.Model
{
    ...
    public partial class SysUserQueryModel
    {
        ...
        public int? minID
        {
            get
            {
                var con = m_ConditionList.Where(t => t.ConditionName == "minID").FirstOrDefault();
                if (con != null)
                {
                    return (int)con.Value;
                }
        ...
        public int? maxID
        {
            get
            {
                var con = m_ConditionList.Where(t => t.ConditionName == "maxID").FirstOrDefault();
                if (con != null)
                {
                    return (int)con.Value;
                }
        ...
        public int? minStatus
        {
            get
            {
                var con = m_ConditionList.Where(t => t.ConditionName == "minStatus").FirstOrDefault();
                if (con != null)
                {
                    return (int)con.Value;
                }
        ...
        public int? maxStatus
        {
            get
            {
                var con = m_ConditionList.Where(t => t.ConditionName == "maxStatus").FirstOrDefault();
                if (con != null)
                {
                    return (int)con.Value;
                }
        ...
        public DateTime? Ts
        {
            get
            {
                var con = m_ConditionList.Where(t => t.ConditionName == "ts").FirstOrDefault();
                if (con != null)
                {
        ...
        public DateTime? minTs
        {
            get
            {
                var con = m_ConditionList.Where(t => t.ConditionName == "mints").FirstOrDefault();
                if (con != null)
                {
                    return (DateTime)con.Value;
                }
        ...
        public DateTime? maxTs
        {
            get
            {
                var con = m_ConditionList.Where(t => t.ConditionName == "maxts").FirstOrDefault();
                if (con != null)
                {
                    return (DateTime)con.Value;
                }
